...
$("div[data-label=FileInput2]").append("<input type='file' id='UploadInput2' style='position:relative; float:left; opacity:0; font-size: 400px; width: 100%; height: 100%;'>");
...
$("div[data-label=UploadPreview2]").children("img").css({"width": "auto", "height": "auto", "maxHeight": "92%", "maxWidth": "92%", "margin": "auto", "padding": "6px", "position": "absolute", "top": "0", "bottom": "0", "right": "0", "left": "0"});
...
function readURL(input) {
	if (input.files && input.files[0]) {
		...
		reader.onload = function (e) {
			$('[data-label="UploadPreview2"]').children('img').attr('src', e.target.result);
		}
...
$('#UploadInput2').change(function(){
	...
	$("div[data-label=UploadPreview2]").css({"border": "1px solid #f2f2f2", "opacity": "1.0", "box-shadow": "0px 0px 7px #f8f8f8"});
});
